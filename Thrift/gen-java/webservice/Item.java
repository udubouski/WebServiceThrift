...
public class Item implements org.apache.thrift.TBase<Item, Item._Fields>, java.io.Serializable, Cloneable, Comparable<Item> {
  ...
  public Item setFirstName(java.lang.String firstName) {
    this.firstName = firstName;
    return this;
  }
  ...
  public Item setSecondName(java.lang.String secondName) {
    this.secondName = secondName;
    return this;
  }
  ...
  public Item setNumberCourse(long numberCourse) {
    this.numberCourse = numberCourse;
    setNumberCourseIsSet(true);
    return this;
  }
  ...
  public Item setNumberGroup(long numberGroup) {
    this.numberGroup = numberGroup;
    setNumberGroupIsSet(true);
    return this;
  }
